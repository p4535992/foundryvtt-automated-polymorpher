    ...
    animationFunctions: {
        ...
        lightning2: {
            fn: async (template, tokenData) => {
                ...
                await new Sequence()
                    .effect()
                    .file(`modules/${AUTOMATED_POLYMORPHER_MODULE_NAME}/assets/animations/JB2A/LightningBall_01_Regular_Blue_400x400.webm`)
                    .belowTokens()
                    .randomRotation()
                    .atLocation(template)
                    .scale(Math.max(tokenData.width, tokenData.height) * tokenData.scale * 0.55)
                    ...
                    .wait(750)
                    .effect()
                    .file(`modules/${AUTOMATED_POLYMORPHER_MODULE_NAME}/assets/animations/JB2A/Impact_12_Regular_Blue_400x400.webm`)
                    .belowTokens()
                    .randomRotation()
                    .atLocation(template)
                    .scale(Math.max(tokenData.width, tokenData.height) * tokenData.scale * 0.55)
        ...
        ice1: {
            fn: async (template, tokenData) => {
                ...
                await new Sequence()
                    .effect()
                    .file(`modules/${AUTOMATED_POLYMORPHER_MODULE_NAME}/assets/animations/JB2A/SnowflakeBurst_01_Regular_BlueWhite_Burst_600x600.webm`)
                    .belowTokens()
                    ...
                    .wait(650)
                    .effect()
                    .file(`modules/${AUTOMATED_POLYMORPHER_MODULE_NAME}/assets/animations/JB2A/IceSpikesRadialBurst_01_Regular_White_1000x1000.webm`)
                    .randomRotation()
                    .atLocation(template)
                    .scale(Math.max(tokenData.width, tokenData.height) * tokenData.scale * 0.55)
                    .play();
        ...
        darkness: {
            fn: async (template, tokenData) => {
                ...
                await new Sequence()
                    .effect()
                    .file(`modules/${AUTOMATED_POLYMORPHER_MODULE_NAME}/assets/animations/JB2A/Whirlwind_01_BlueGrey_01_400x400.webm`)
                    .belowTokens()
                    .fadeIn(500, { ease: 'easeOutCubic', delay: 500 })
                    .fadeOut(1500)
                    .rotateIn(90, 2500, { ease: 'easeInOutCubic' })
        ...
        magic2: {
            fn: async (template, tokenData) => {
                ...
                await new Sequence()
                    .effect()
                    .file(`modules/${AUTOMATED_POLYMORPHER_MODULE_NAME}/assets/animations/JB2A/Conjuration_01_Yellow_Circle_800x800.webm`)
                    .belowTokens()
                    .fadeIn(500, { ease: 'easeOutCubic', delay: 500 })
                    .fadeOut(1500)
                    .rotateIn(90, 2500, { ease: 'easeInOutCubic' })
        ...
        music2: {
            fn: async (template, tokenData) => {
                ...
                await new Sequence()
                    .effect()
                    .file(`modules/${AUTOMATED_POLYMORPHER_MODULE_NAME}/assets/animations/JB2A/OutPulse_01_Regular_BlueWhite_Burst_600x600.webm`)
                    .belowTokens()
                    .atLocation(template)
                    .randomRotation()
                    .scale(Math.max(tokenData.width, tokenData.height) * tokenData.scale * 0.35)
                    .wait(100)
                    .effect()
                    .file(`modules/${AUTOMATED_POLYMORPHER_MODULE_NAME}/assets/animations/JB2A/BardicInspiration_01_Regular_GreenOrange_400x400.webm`)
                    .atLocation(template)
                    .scale(Math.max(tokenData.width, tokenData.height) * tokenData.scale * 0.45)
                    .play();
            },

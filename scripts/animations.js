    ...
    animationFunctions: {
        fire: {
            fn: async (template, tokenData) => {
                ...
                await new Sequence()
                    ...
                    .randomRotation()
                    .atLocation(template)
                    .scale(((Math.max(tokenData.width, tokenData.height) *
                    //@ts-ignore
        ...
        ice1: {
            fn: async (template, tokenData) => {
                ...
                await new Sequence()
                    .effect()
                    .file(`modules/${CONSTANTS.MODULE_NAME}/assets/animations/JB2A/SnowflakeBurst_01_Regular_BlueWhite_Burst_600x600.webm`)
                    .belowTokens()
                    ...
                    .wait(650)
                    .effect()
                    .file(`modules/${CONSTANTS.MODULE_NAME}/assets/animations/JB2A/IceSpikesRadialBurst_01_Regular_White_1000x1000.webm`)
                    .randomRotation()
                    .atLocation(template)
                    .scale(((Math.max(tokenData.width, tokenData.height) *
                    //@ts-ignore
        ...
        music2: {
            fn: async (template, tokenData) => {
                ...
                await new Sequence()
                    .effect()
                    .file(`modules/${CONSTANTS.MODULE_NAME}/assets/animations/JB2A/OutPulse_01_Regular_BlueWhite_Burst_600x600.webm`)
                    .belowTokens()
                    .atLocation(template)
                    .randomRotation()
                    .scale(((Math.max(tokenData.width, tokenData.height) *
                    ...
                    .wait(100)
                    .effect()
                    .file(`modules/${CONSTANTS.MODULE_NAME}/assets/animations/JB2A/BardicInspiration_01_Regular_GreenOrange_400x400.webm`)
                    .atLocation(template)
                    .scale(((Math.max(tokenData.width, tokenData.height) *
                    //@ts-ignore
                    (tokenData.texture.scaleX + tokenData.texture.scaleY)) /

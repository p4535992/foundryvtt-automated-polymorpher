		...
		lightning2: {
			fn: async (template: Token, tokenData: TokenData) => {
				...
				await new Sequence()
					.effect()
					.file(
						`modules/${CONSTANTS.MODULE_NAME}/assets/animations/JB2A/LightningBall_01_Regular_Blue_400x400.webm`
					)
					.belowTokens()
					.randomRotation()
					.atLocation(template)
		...
		darkness: {
			fn: async (template: Token, tokenData: TokenData) => {
				...
				await new Sequence()
					.effect()
					.file(
						`modules/${CONSTANTS.MODULE_NAME}/assets/animations/JB2A/Whirlwind_01_BlueGrey_01_400x400.webm`
					)
					.belowTokens()
					.fadeIn(500, { ease: "easeOutCubic", delay: 500 })
					.fadeOut(1500)
		...
		magic2: {
			fn: async (template: Token, tokenData: TokenData) => {
				...
				await new Sequence()
					.effect()
					.file(
						`modules/${CONSTANTS.MODULE_NAME}/assets/animations/JB2A/Conjuration_01_Yellow_Circle_800x800.webm`
					)
					.belowTokens()
					.fadeIn(500, { ease: "easeOutCubic", delay: 500 })
					.fadeOut(1500)
